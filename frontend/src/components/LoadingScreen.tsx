...
export default function LoadingScreen({ error }: LoadingScreenProps) {
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-msrp-bg text-msrp-text px-4">
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-msrp-bg text-msrp-text">
      <h1 className="text-2xl font-bold mb-4">MSRP</h1>
